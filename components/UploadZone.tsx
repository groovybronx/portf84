      ...
      >
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  {supportsFileSystem
                    ? "Select a specific album to view"
                    : "or drag and drop your collection here"}
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
            ...
            {supportsFileSystem && (
              <button
                ...
                className="flex items-center gap-3 px-4 py-3 rounded-xl bg-glass-bg-accent border border-glass-border-light hover:bg-green-500/10 hover:border-green-500/30 hover:text-green-300 transition-all text-gray-400 text-sm text-left group"
              >
                <ShieldCheck
                  size={20}
                  className="text-green-500/50 group-hover:text-green-400"
                />
                <div className="flex-1">
                  <p className="font-medium text-gray-300 group-hover:text-green-300">
                    Link Root Folder
                  </p>
                  <p className="text-[10px] opacity-60">
                    Authorize parent folder once to avoid future popups.
                  </p>
                </div>
              </button>
            )}
            ...
            {hasStoredSession && (
              <motion.button
                ...
                className="flex items-center gap-3 px-4 py-3 rounded-xl bg-glass-bg-accent border border-glass-border-light hover:bg-blue-500/10 hover:border-blue-500/30 hover:text-blue-300 transition-all text-gray-400 text-sm text-left group"
              >
                <History
                  size={20}
                ...
                />
                <div className="flex-1">
                  <p className="font-medium text-gray-300 group-hover:text-blue-300">
                    Restore Session
                  </p>
                  <p className="text-[10px] opacity-60">
                    Resume working on your last collection.
                  </p>
                </div>
              </motion.button>
            )}
        ...
        <div className="flex justify-center gap-8 text-xs text-gray-600 font-mono pt-4">
          <span className="flex items-center gap-2">
            <UploadCloud size={12} /> Local Processing
          </span>
          <span className="flex items-center gap-2">
            <ImageIcon size={12} /> Auto-Grid Layout
          </span>
        </div>
      </motion.div>
    </div>

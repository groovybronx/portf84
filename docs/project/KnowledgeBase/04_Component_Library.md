...
## Overview
Lumina Portfolio uses a custom component system built with **React 19.2**, **Tailwind CSS v4**, and **Framer Motion**. The UI is designed to be dark, sleek, and content-focused.

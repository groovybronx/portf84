...
- [ ] Migrer le dernier button HTML (15 min)
- [ ] Audit et migration GlassCard (2-3h)
- [ ] Migration Layouts - 10+ fichiers (2-3 jours)

**MOYENNE PRIORITÉ** (Semaine 2):
- [ ] Simplifier SettingsModal (2 jours)
- [ ] Créer composants Overlay (2 jours)
- [ ] Audit final et documentation (1 jour)
...
- [ ] Test visuel: Les tag chips s'affichent correctement
- [ ] Test interaction: Le clic sur X retire bien le filtre
- [ ] Test accessibilité: aria-label présent
...
#### Validation
- [ ] Créer fichier \`/tmp/glass-audit.md\` avec classification
- [ ] Objectif <15 fichiers features avec glass inline atteint
- [ ] Tests visuels: Aucune régression d'apparence
...
**Livrables Jour 1**:
- [ ] Liste 20-30 fichiers candidats avec scoring
- [ ] Guide de migration patterns documenté
...
**Livrables Jour 2**:
- [ ] 5 fichiers navigation migrés
- [ ] Tests visuels passés (screenshots)
...
**Livrables Jour 3**:
- [ ] 8 fichiers collections/tags migrés
- [ ] Total cumulé: 13 fichiers migrés (objectif 10+ atteint ✅)
...
- [ ] ✅ 1 seul \`<button>\` HTML (dans Button.tsx)
...
1. **Créer \`LanguageSelector.tsx\`** (1h) - ~30 lignes
2. **Créer \`ShortcutEditor.tsx\`** (2h) - ~80 lignes
3. **Créer \`ThemeCustomizer.tsx\`** (1.5h) - ~60 lignes

**Jour 2: Refactoring** (4-6h)

4. **Simplifier state management** (2h)
5. **Intégrer nouveaux composants** (2h)
...
Features:
- [ ] Animation slide selon side (left/right/top/bottom)
...
Features:
- [ ] Positionnement automatique avec floating-ui
- [ ] Flèche pointer CSS
- [ ] Gestion collisions viewport
...
- Créer CONTRIBUTING_UI.md

#### Après-midi: Documentation Finale (4h)

- [ ] Guide de contribution UI (2h)
- [ ] Rapport final (1h)
- [ ] Screenshots et assets (1h)
...
**Buttons Migration**:
- [ ] \`grep -r "<button" src --include="*.tsx" | wc -l\` = **1**

**GlassCard Migration**:
- [ ] **<15 fichiers** features avec glass inline

**Layouts Migration**:
- [ ] **10+ fichiers** migrés vers Stack/Flex/Grid

        ...
        >
          ...
          >
            <Stack spacing="md">
              ...
              <Flex justify="between" align="center" className="pb-3 border-b border-white/10">
                <Flex align="center" gap="md">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-white">{t('tags:batchTagging')}</h2>
              ...
              {/* Common Tags */}
              <CommonTags
                tags={tagAnalysis.common.filter((tag) => !pendingChanges.remove.has(tag))}
              ...
              {/* Preview */}
              <PreviewSection changes={previewChanges} totalItems={selectedItems.length} />
              ...
              <Flex justify="end" gap="sm" className="pt-3 border-t border-white/10">
                ...
                <Button
                  onClick={handleApply}
                  disabled={pendingChanges.add.size === 0 && pendingChanges.remove.size === 0}
                  className="min-w-32"
                >
                  {t('tags:applyChanges')}
                </Button>
            ...
            <div className="text-xs text-gray-500 text-center">
              <kbd className="px-1.5 py-0.5 bg-white/5 rounded">Esc</kbd> {t('common:toCancel')} •{' '}
              <kbd className="px-1.5 py-0.5 bg-white/5 rounded">Ctrl+Enter</kbd> {t('tags:toApply')}
            </div>
          </motion.div>
        </GlassCard>
      </div>

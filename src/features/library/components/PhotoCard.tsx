...
export const PhotoCard: React.FC<PhotoCardProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="backface-hidden rounded-lg overflow-hidden bg-glass-bg-accent"
          style={{
        ...
        <div
          className="absolute inset-0 bg-slate-950/95 p-5 flex flex-col gap-4 overflow-y-auto custom-scrollbar rounded-lg border border-white/10"
          style={{
            backfaceVisibility: "hidden",
            WebkitBackfaceVisibility: "hidden",

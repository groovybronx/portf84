...
interface SelectionContextType extends SelectionState {
  ...
  handleMouseMove: (e: React.MouseEvent, processedItems: PortfolioItem[]) => void;
  handleMouseUp: () => void;
...
export const SelectionProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const handleMouseDown = useCallback(
    (e: React.MouseEvent, viewMode: ViewMode, processedItems: PortfolioItem[]) => {
  ...
  const handleMouseMove = useCallback(
    (e: React.MouseEvent, _processedItems: PortfolioItem[]) => {
      ...
      if (state.isDragSelecting) {
        ...
        rafId.current = requestAnimationFrame(() => {
          ...
          const initialSet =
            e.shiftKey || e.ctrlKey || e.metaKey ? state.selectedIds : new Set<string>();

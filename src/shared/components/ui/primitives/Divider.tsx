			...
			<div
				...
				className={cn(
					"shrink-0",
					{
						...
						"border-t border-dashed border-white/10": orientation === "horizontal" && variant === "dashed",
						"border-l border-dashed border-white/10": orientation === "vertical" && variant === "dashed",

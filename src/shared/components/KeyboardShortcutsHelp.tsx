      ...
      {isOpen && (
        <>
          ...
          <GlassCard
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl rounded-xl! shadow-2xl z-(--z-modal) flex flex-col max-h-[85vh] overflow-hidden"
          >
            {/* Header */}
            <div className="p-6 border-b border-white/10 flex justify-between items-center bg-glass-bg-accent">
              ...
              <Button onClick={onClose} variant="close" size="icon">
                <X size={20} />
              </Button>
            </div>
